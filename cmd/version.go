...
var versionHelp = `
This command will output the build number, version number and build date of fox. 
...
These information might help debugging, please provide them if you open an issue
on GitHub.

If both values are "unknown" make sure to build fox with "make".
`
